...
class RadiologyWorkingHoursAdapter(
    val workingHours: ArrayList<RadiologyWorkingHour>,
    val context: Context
) :
    RecyclerView.Adapter<RadiologyWorkingHoursAdapter.MyViewHolder>() {
    ...
    fun setData(data: ArrayList<RadiologyWorkingHour>) {
        clearData()
