...
class WaveAppBarLayout : AppBarLayout
{
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs)
    {
        ...
        try
        {
            ...
            curve_1_width_path_1_percentage =
                attrArray.getFloat(R.styleable.WaveAppBarLayout_FirstCurvePercentageWidthOfFirstWave
                    , def_curve_width_percentage)
            curve_1_width_path_1_percentage = attrArray.getFloat(R.styleable.WaveAppBarLayout_SecondCurvePercentageWidthOfFirstWave
                , def_curve_width_percentage)
    ...
    private fun init()
    {
        p = if (!auto_bottom_padding) 0.5f else 2.4f
        ...
        // TODO
        // but elevation = 0 in code not in xml.
    }
