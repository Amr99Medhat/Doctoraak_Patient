...
object ApiOthers {
    ...
    BaseResponseListener<UserResponse>) {
        ...
        val call: Call<UserResponse> = if (file.exists()){
            service.updateProfile(part!! ,user_id , name
                ,gender , birthdate ,address , api_token)
        }else{
            service.updateProfile(user_id , name
                ,gender , birthdate ,address , api_token)
        }
        call.start(callback)
    }
    ...
    fun getReservations(patientId : Int , api_token : String
    ...
    {
        val service = ApiConfigure.mainRetrofit.create(ApiEndPoint::class.java)
        val call: Call<NotificationsResponse> = service.getNotifications(userId
            , userType,api_token)
        call.start(callback)
    }
    ...
    fun updateFirebaseToken(firebase_token: String, user_id: Int, user_type: String, api_token: String,
    ...
    fun getMyOrdersDoctor(api_token: String, patient_id: Int, callback: BaseResponseListener<ReservationsResponse>)
    {
        val service = ApiConfigure.mainRetrofit.create(ApiEndPoint::class.java)
    ...
    fun getMyOrdersPharmacy(api_token: String, patient_id: Int, callback: BaseResponseListener<PharmacyOrdersListResponse>)
    {
        val service = ApiConfigure.mainRetrofit.create(ApiEndPoint::class.java)
    ...
    fun getMyOrdersLab(api_token: String, patient_id: Int, callback: BaseResponseListener<LabOrdersListResponse>)
    {
        val service = ApiConfigure.mainRetrofit.create(ApiEndPoint::class.java)
    ...
    fun getMyOrdersRadiology(api_token: String, patient_id: Int, callback: BaseResponseListener<RadiologyOrdersListResponse>)
    {
        val service = ApiConfigure.mainRetrofit.create(ApiEndPoint::class.java)
